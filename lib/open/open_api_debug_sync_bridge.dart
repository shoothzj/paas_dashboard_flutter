...
class OpenApiDebugSyncBridge with $Bridge<OpenApiDebugSync> {
  static const $type = BridgeTypeReference.unresolved(
      BridgeUnresolvedTypeReference('package:paas_dashboard_flutter/open/open_api_debug_sync.dart', 'OpenApiDebugSync'),
      []);
  ...
  static const $declaration = BridgeClassDeclaration($type, isAbstract: false, constructors: {}, methods: {
    'helloWorld': BridgeMethodDeclaration(
        ...
        BridgeFunctionDescriptor(
            BridgeTypeAnnotation(BridgeTypeReference.type(RuntimeTypes.stringType, []), false), {}, [], {})),
