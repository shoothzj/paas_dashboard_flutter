...
class PulsarPartitionedTopicProducerWidget extends StatefulWidget {
  const PulsarPartitionedTopicProducerWidget();

  @override
  State<StatefulWidget> createState() {
    return PulsarPartitionedTopicProducerWidgetState();
  }
}

class PulsarPartitionedTopicProducerWidgetState extends State<PulsarPartitionedTopicProducerWidget> {
  @override
  void initState() {
    super.initState();
    final vm = Provider.of<PulsarPartitionedTopicProducerViewModel>(context, listen: false);
    vm.fetchProducers();
  }

  @override
  Widget build(BuildContext context) {
    final vm = Provider.of<PulsarPartitionedTopicProducerViewModel>(context);
    if (vm.loading) {
