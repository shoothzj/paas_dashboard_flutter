...
class MongoTableListViewModel
    extends BaseLoadListPageViewModel<MongoTableViewModel> {
  ...
  MongoTableListViewModel deepCopy() {
    return new MongoTableListViewModel(
  ...
  Future<void> fetchTables() async {
    try {
      ...
      this.fullList = results
          .map((e) => MongoTableViewModel(mongoInstancePo, databaseResp, e))
          .toList();
